 ...
 */
class Tx_JhPwcommentsFeed_ViewHelpers_DateViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	 ...
	 */
	public function render($date = NULL, $format = '%Y-%m-%d', $currentDate = FALSE, $strftime = TRUE, $timestamp = NULL) {
		if ($currentDate) {
			if ($strftime) {
